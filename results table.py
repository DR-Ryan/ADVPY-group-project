...
results_info.execute('''CREATE TABLE IF NOT EXISTS results (score real, correct int)''') # Creates Table for results info

#Insert base data
results_info.execute('''INSERT INTO results (score, correct) VALUES(2.1,4)''')
