...
class FractionsHelper:
    ...
    def menu(self, click):
        ...
        self.solverButton = Button(self.container1, text = "Solver", height = 6, width = 84, borderwidth = 2, bg="red")
        # self.solverButton.pack(side=LEFT, padx=(0, 100))
        self.solverButton.place(x=15, y = 0)
        self.solverButton.bind("<Button-1>", self.solver)

        self.quizzerButton = Button(self.container1, text = "Quizzer", height = 6, width = 84, borderwidth = 2, bg="white")
        # self.quizzerButton.pack(side=LEFT, padx=(0, 100))
        self.quizzerButton.place(x=15, y= 150)
        self.quizzerButton.bind("<Button-1>", self.quizzer)

        self.resultsButton = Button(self.container1, text = "Results", height = 6, width = 84, borderwidth = 2, bg="blue")
        # self.resultsButton.pack(side=LEFT, padx=(0, 100))
        self.resultsButton.place(x=15, y=300)
